var dataFreeName = localStorage.getItem("dataFreeName");
console.log(dataFreeName);
var dataFreeReviews = localStorage.getItem("dataFreeReviews");
console.log(dataFreeReviews);
var Finalla = "http://127.0.0.1:8080/all/" + dataFreeName;
console.log(Finalla);
var Finallatable = "http://127.0.0.1:8080/app/reviews/" + dataFreeName;
...
$(function() {
  if (dataFreeName == dataFreeName || dataFreeReviews == dataFreeReviews) {
