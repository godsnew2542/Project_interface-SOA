var FinalAllName = localStorage.getItem("FinalAllName");
console.log(FinalAllName);
var Finalla = "http://127.0.0.1:8080/all/" + FinalAllName;
console.log(Finalla);
var Finallatable = "http://127.0.0.1:8080/app/reviews/" + FinalAllName;
