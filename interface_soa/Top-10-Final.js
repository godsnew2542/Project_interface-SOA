var TopReview = localStorage.getItem("TopReview");
console.log(TopReview);
var Finalla = "http://127.0.0.1:8080/all/" + TopReview;
console.log(Finalla);
var Finallatable = "http://127.0.0.1:8080/app/reviews/" + TopReview;
