var TopPriceName = localStorage.getItem("TopPriceName");
console.log(TopPriceName);
var Finalla = "http://127.0.0.1:8080/all/" + TopPriceName;
console.log(Finalla);
var Finallatable = "http://127.0.0.1:8080/app/reviews/" + TopPriceName;
